		...
		<a href="myaccount.php">My Account</a>
				...
				<nav>
					<ul>
						...
						<li>
			            	<a href="index.php?logout='1'" style="color: red;" onclick="loadXMLDoc()">logout</a></li>
			            <?php else : ?>
...
if (isset($_POST["submit"])) {
	$str = $_POST["search"];
	$sth = $con->prepare("SELECT * FROM `search` WHERE Name LIKE '$str%'");
		...
		<article id="main-col">
					...
					<ul id="services">
						<li>
							...
							<p>Pricing: $<?php echo $row->pricing;?> - $<?php echo $row->alterpricing;?> <?php echo $row->priceper;?></p>
						</li>
					</ul>
		</article>
<?php
